...
public class FDZSurfaceBuilders {
    ...
    public static final RegistryObject<SurfaceBuilder<?>> DEFAULT_FDZ = SURFACE_BUILDERS.register("fdz_surfacebuilder", () -> new FDZDefaultSurfaceBuilder(SurfaceBuilderConfig.CODEC));
